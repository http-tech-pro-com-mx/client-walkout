...
export class IpFormComponent implements OnInit, OnDestroy {
  ...
  plugins() {
    ...
    this.formGrid = this.fb.group({
      ...
      total_casas: new FormControl({ value: '', disabled: this.ip.tipo == 2 }, [Validators.required, Validators.pattern(/^[0-9]+$/)]),
      total_negocios: new FormControl({ value: '', disabled: this.ip.tipo == 2 }, [Validators.required, Validators.pattern(/^[0-9]+$/)]),
      total_escuelas: new FormControl({ value: '', disabled: this.ip.tipo == 2 }, [Validators.required, Validators.pattern(/^[0-9]+$/)]),
      total_iglesias: new FormControl({ value: '', disabled: this.ip.tipo == 2 }, [Validators.required, Validators.pattern(/^[0-9]+$/)]),
      total_baldios: new FormControl({ value: '', disabled: this.ip.tipo == 2 }, [Validators.required, Validators.pattern(/^[0-9]+$/)]),
